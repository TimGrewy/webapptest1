...
/* harmony import */ var _title_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../title.service */ "./src/title.service.ts");
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.getTitles = function () {
        var _this = this;
    ...
    AppComponent.prototype.delete = function (title) {
        title = title.trim();
        if (!title) {
            return;
        }
...
var TitleService = /** @class */ (function () {
    ...
    function TitleService(http) {
        this.http = http;
        this.listUrl = 'http://localhost/rest/scanner/list'; // URL to web api
        this.titleUrl = 'http://localhost/rest/scanner/title'; // URL to web api
        this.listUrlProd = '/rest/scanner/list'; // URL to web api prod
        this.titleUrlProd = '/rest/scanner/title'; // URL to web api prod
    }
    //******************************************************************
    //PUBLIC METHODS
    //******************************************************************
    TitleService.prototype.getTitles = function () {
        return this.http.get(this.listUrlProd)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('getTitle', [])));
    };
    /** POST: add a new hero to the server */
    TitleService.prototype.addTitle = function (title) {
        return this.http.post(this.titleUrlProd, title, httpOptionsPost)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('addTitle')));
    };
    /** POST: add a new hero to the server */
    TitleService.prototype.deleteTitle = function (title) {
        return this.http.delete(this.titleUrlProd + "/" + title, httpOptionsPost)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('deleteTitle')));
    };
    //******************************************************************
    //PRIVATE METHODS
    //******************************************************************
...
module.exports = __webpack_require__(/*! C:\Users\Tim\IdeaProjects\webapptest1\src\Angular\grewy-dk\src\main.ts */"./src/main.ts");
